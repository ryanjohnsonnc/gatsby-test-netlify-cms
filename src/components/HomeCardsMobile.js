...
class HomeCardsMobile extends React.Component {
  constructor(){
    super();
  ...
  render() {
    ...
    return (
      <div className={`c_homeCardsMobile`}>
        <div className="">
          <div className="homeCardsMobile_wrapper">
            <Slider {...cardSettings}>
              {this.props.cards.map(card => (
                
                <div key={card.solution} className="homeCardsMobile_card">
                  <div>                    
                    <figure 
